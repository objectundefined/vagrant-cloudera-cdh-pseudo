...
cd /home/vagrant/
echo "Add Cloudera Manager"
sudo mkdir /home/installers
sudo wget -c http://archive.cloudera.com/cm5/installer/5.4.1/cloudera-manager-installer.bin -P /home/installers
sudo chmod +x /home/installers/cloudera-manager-installer.bin
sudo sh /home/installers/cloudera-manager-installer.bin
